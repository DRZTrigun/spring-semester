...
import geekbrains.client.AuthException;
import geekbrains.client.TextMessage;
import geekbrains.server.auth.AuthService;
import geekbrains.server.auth.AuthServiceJdbcImpl;
import geekbrains.server.persistance.UserRepository;
...
import static geekbrains.client.MessagePatterns.AUTH_FAIL_RESPONSE;
import static geekbrains.client.MessagePatterns.AUTH_SUCCESS_RESPONSE;
...
//                userRepository.insert(new geekbrains.server.User(-1, "ivan", "123"));
//                userRepository.insert(new geekbrains.server.User(-1, "petr", "345"));
//                userRepository.insert(new geekbrains.server.User(-1, "julia", "789"));
//            }
...
//    }
    ...
    private void sendUserConnectedMessage(String login) throws IOException {
        for (geekbrains.server.ClientHandler clientHandler : clientHandlerMap.values()) {
